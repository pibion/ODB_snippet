...
will be stored, which are different than start_odb (this is theory, but we are not applying this because Final_ODB size was smaller than previously so, we only do same like start ODB JSON)
